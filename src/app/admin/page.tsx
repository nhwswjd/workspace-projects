            ...
            <div className="overflow-x-auto -mx-2 px-2">
              <table className="w-full min-w-[900px]">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-2 py-10 md:px-3 md:py-10 text-left text-xs md:text-sm font-medium text-gray-600 w-12 md:w-16">序号</th>
                    <th className="px-2 py-10 md:px-3 md:py-10 text-left text-xs md:text-sm font-medium text-gray-600 w-20 md:w-24">
                      编号
                      <select
                        value={filterSku}
                    ...
                    <th className="px-2 py-10 md:px-3 md:py-10 text-left text-xs md:text-sm font-medium text-gray-600">
                      名称
                      <input
                        type="text"
                        value={filterName}
                    ...
                    <th className="px-3 py-10 text-left text-sm font-medium text-gray-600">
                      排序
                      <select
                    ...
                    <th className="px-3 py-10 md:px-3 md:py-10 text-left text-sm font-medium text-gray-600">
                      排序
                      <select
                        value={`${sortBy}-${sortDirection}`}
                        onChange={(e) => {
                    ...
                    <th className="px-2 py-10 md:px-3 md:py-10 text-right text-xs md:text-sm font-medium text-gray-600 w-20 md:w-32">操作</th>
                  </tr>
                </thead>
                  ...
                  {filteredProducts.length === 0 ? (
                    ...
                    filteredProducts.map((product, index) => (
                      <tr key={product.id} className={`hover:bg-gray-50 ${product.hidden ? 'bg-gray-100' : ''}`}>
                        {/* 序号 */}
                        <td className="px-2 py-10 md:px-3 md:py-10 text-xs md:text-sm text-gray-600 text-center">{index + 1}</td>
                        
                        {/* 编号 - 可编辑 */}
                        <td className="px-2 py-10 md:px-3 md:py-10 text-xs md:text-sm">
                        ...
                        {/* 操作 */}
                        <td className="px-2 py-10 md:px-3 md:py-10 text-right">
