        ...
        <div className="bg-white px-4 py-[19px]">
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-20 h-[58px] bg-gray-50 border border-gray-200 rounded-xl text-sm placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-200/50 focus:border-emerald-300"
            />
        ...
        <div className="bg-white px-4 py-[19px]">
          <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
            <button
              ...
              className={`flex-shrink-0 px-4 h-[58px] text-sm font-medium rounded-full transition-all ${
